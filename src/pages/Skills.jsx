...
const ROWS = [
  [
    ...
    { title: "Databases & Tools", items: [ "MongoDB", "Git","Firebase"] },
    { title: "Frameworks & Libraries", items: ["TensorFlow", "OpenCV"] },
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Teamwork", "Problem Solving", "Creativity", "Adaptability", "Technical skills"],
    },
  ],
];
